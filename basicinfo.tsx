...
const yourName : String = "Ryan Sexton";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "sophomore";
let oneExcite : String = "Learning actualy software";
let anyConcerns : String = "remembering git commands";
let funFact : String = "I played baseball for my whole life";
